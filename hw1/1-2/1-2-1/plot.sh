...
#plot
python3 plot.py  -o pic/output_all_layer.png -m all_layer -i  record/para1.npy record/para2.npy record/para3.npy record/para4.npy record/para5.npy record/para6.npy record/para7.npy record/para8.npy record/para9.npy record/para10.npy
