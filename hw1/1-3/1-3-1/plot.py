...
############################################################
plt.figure()
plt.plot(x,dm.data['train'][:,0],'b',label='train')
plt.plot(x,dm.data['test'][:,0],'g',label='test')
plt.title('Loss')
plt.legend()
...
############################################################
plt.figure()
plt.plot(x,dm.data['train'][:,1],'b',label='train')
plt.plot(x,dm.data['test'][:,1],'g',label='test')
plt.title('Accu')
plt.legend()
