...
class Agent_PG(Agent):
    def __init__(self, env, args):
        ...
        if args.test_pg: 
            ...
            self.model.load_state_dict(torch.load('policy_gradient_model_v3.pt'))
            self.model.eval() 
    ...
    def select_action(self,state,test=False):
        ...
        if not test : self.model.saved_log_probs.append(m.log_prob(action))  # Save Log probablities
    ...
    def train(self):
        ...
        for i_episode in count(1):
            ...
            if average_reward > best_average_reward :
                ...
                torch.save(self.model.state_dict(), 'model/policy_gradient_model_v3.pt')
                print('model saved') 
